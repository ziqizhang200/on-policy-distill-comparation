...
本目录为“基于在线策略蒸馏的大语言模型后训练方法研究”维护统一参考文献。截至 **2026-09-23**，已收录 **34 条**。正式文献库保留已核验的学术论文、预印本和模型技术报告，不收录技术博客；开题报告参考文献进一步精选为与研究问题直接相关的 21 条来源，并优先采用 ICLR、ICML、ACL、EMNLP、NeurIPS、SOSP 等正式会议或期刊版本。
